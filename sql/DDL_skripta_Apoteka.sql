...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `apoteka`.`MJESTO` (
...
CREATE TABLE IF NOT EXISTS `apoteka`.`APOTEKA` (
  ...
  INDEX `fk_APOTEKA_MJESTO_idx` (`BrojPoste` ASC) VISIBLE,
  CONSTRAINT `fk_APOTEKA_MJESTO`
    FOREIGN KEY (`BrojPoste`)
    REFERENCES `apoteka`.`MJESTO` (`BrojPoste`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `apoteka`.`PROIZVODJAC` (
  ...
  INDEX `fk_DOBAVLJAC_MJESTO1_idx` (`BrojPoste` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `apoteka`.`BANKA` (
  ...
  `BrojPoste` INT(11) NOT NULL,
  PRIMARY KEY (`IdBanke`),
  INDEX `fk_BANKA_MJESTO1_idx` (`BrojPoste` ASC) VISIBLE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `apoteka`.`ZAPOSLENI` (
  ...
  INDEX `fk_ZAPOSLENI_APOTEKA1_idx` (`IdApoteke` ASC) VISIBLE,
  INDEX `fk_ZAPOSLENI_MJESTO1_idx` (`BrojPoste` ASC) VISIBLE,
  UNIQUE INDEX `KorisnickoIme_UNIQUE` (`KorisnickoIme` ASC) VISIBLE,
  CONSTRAINT `fk_ZAPOSLENI_APOTEKA1`
...
CREATE TABLE IF NOT EXISTS `apoteka`.`FAKTURA` (
  ...
  INDEX `fk_FAKTURA_ZAPOSLENI1_idx` (`IdZaposlenog` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_FAKTURA_ZAPOSLENI1`
    ...
    REFERENCES `apoteka`.`ZAPOSLENI` (`IdZaposlenog`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `apoteka`.`KOZMETIKA` (
  `JedinicaMjere` VARCHAR(10) NOT NULL,
  `Barkod` INT NOT NULL,
  PRIMARY KEY (`Barkod`),
  CONSTRAINT `fk_kozmetika_artikal1`
    FOREIGN KEY (`Barkod`)
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `apoteka`.`MAGISTAR_FARMACIJE` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `apoteka`.`MEDICINSKI_APARAT` (
  `Barkod` INT NOT NULL,
  PRIMARY KEY (`Barkod`),
  CONSTRAINT `fk_MEDICINSKI_APARATI_ARTIKAL1`
    FOREIGN KEY (`Barkod`)
    REFERENCES `apoteka`.`ARTIKAL` (`Barkod`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT)
...
CREATE TABLE IF NOT EXISTS `apoteka`.`NARUDZBA` (
  ...
  INDEX `fk_NARUDZBA_ZAPOSLENI1_idx` (`IdZaposlenog` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `apoteka`.`RACUN` (
  ...
  INDEX `fk_RACUN_ZAPOSLENI1_idx` (`IdZaposlenog` ASC) VISIBLE,
